(self["webpackChunkwebpackNumbers"] = self["webpackChunkwebpackNumbers"] || []).push([[338],{
...
/* harmony export */ });
/* harmony import */ var _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6938);
/* harmony import */ var _braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8488);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5625);
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9173);
/* harmony import */ var dompurify__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6742);
      ...
      switch (yystate) {
        ...
        case 67:
          this.$ = [
            ...
            $$[$0 - 1],
            { type: "addMessage", from: $$[$0 - 4].actor, to: $$[$0 - 1].actor, signalType: $$[$0 - 3], msg: $$[$0] },
            { type: "activeEnd", signalType: yy.LINETYPE.ACTIVE_END, actor: $$[$0 - 4], data: $$[$0] }
          ];
          break;
        case 68:
...
const addPopupInteraction = (id, actorCnt2) => {
  (0,_mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.a)(() => {
...
const drawText = function(elem, textData) {
  ...
  const lines = textData.text.split(_mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.c.lineBreakRegex);
  const [_textFontSize, _textFontSizePx] = (0,_mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.p)(textData.fontSize);
  let textElems = [];
  let dy = 0;
...
const getIsMatch = (text) => {
  if (typeof text !== "string" || !text) {
    return false;
  }
  const matchs = text.match(/\sis\s([\S\s]+$)/) || text.match(/^is\s([\S\s]+$)/);
...
const drawActorTypeParticipant = function(elem, actor, conf2, isFooter) {
  ...
  if (dataId) {
    rect.dataid = dataId;
    text = actor.description.replace(/\sis\s([\S\s]+$)/, "").replace(/^is\s([\S\s]+$)/, "");
  }
...
const drawActivation = function(elem, bounds2, verticalPos, conf2, actorActivations2, data) {
  const rect = getNoteRect();
...
const _drawTextCandidateFunc = function() {
  ...
  function byTspan(content, g, x, y, width, height, textAttrs, conf2) {
    ...
    const [_actorFontSize, _actorFontSizePx] = (0,_mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.p)(actorFontSize);
    const lines = content.split(_mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.c.lineBreakRegex);
    for (let i = 0; i < lines.length; i++) {
      const dy = i * _actorFontSize - _actorFontSize * (lines.length - 1) / 2;
      const text = g.append("text").attr("x", x + width / 2).attr("y", y).attr("data-id", textAttrs["dataid"]).style("text-anchor", "middle").style("font-size", _actorFontSizePx).style("font-weight", actorFontWeight).style("font-family", actorFontFamily);
      text.append("tspan").attr("x", x + width / 2).attr("dy", dy).attr("data-id", textAttrs["dataid"]).text(lines[i]);
...
const parseDirective = function(statement, context, type) {
  _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.m.parseDirective(this, statement, context, type);
};
...
const addSignal = function(idFrom, idTo, message = { text: void 0, wrap: void 0 }, messageType, data = void 0) {
...
const autoWrap = () => {
  ...
  return (0,_mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.d)().sequence.wrap;
};
const clear = function() {
  ...
  messages = [];
  sequenceNumbersEnabled = false;
  (0,_mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.i)();
};
const parseMessage = function(str) {
  ...
  _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("parseMessage:", message);
  return message;
};
const parseBoxData = function(str) {
  ...
  const boxData = {
    color,
    text: title !== void 0 ? (0,_mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.j)(title.replace(/^:?(?:no)?wrap:/, ""), (0,_mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.d)()) : void 0,
...
const addLinks = function(actorId, text) {
  ...
  try {
    let sanitizedText = (0,_mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.j)(text.text, (0,_mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.d)());
    sanitizedText = sanitizedText.replace(/&amp;/g, "&");
    sanitizedText = sanitizedText.replace(/&equals;/g, "=");
    const links = JSON.parse(sanitizedText);
    insertLinks(actor, links);
  } catch (e) {
    _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.l.error("error while parsing actor link text", e);
  }
};
...
const addProperties = function(actorId, text) {
  ...
  try {
    ...
    _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.l.error("error while parsing actor properties text", e);
  }
};
...
const addDetails = function(actorId, text) {
  ...
  try {
    ...
    _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.l.error("error while parsing actor details text", e);
  }
};
  ...
  if (Array.isArray(param)) {
    ...
    switch (param.type) {
      ...
      case "activeEnd":
        ...
        addSignal(param.actor, void 0, void 0, param.signalType, data);
        break;
      case "addNote":
      ...
      case "altEnd":
        ...
        break;
      case "setAccTitle":
        (0,_mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.e)(param.text);
        break;
      case "parStart":
...
const db = {
  ...
  getActorKeys,
  getActorProperty,
  getAccTitle: _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.g,
  getBoxes,
  getDiagramTitle: _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.b,
  setDiagramTitle: _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.s,
  parseDirective,
  getConfig: () => (0,_mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.d)().sequence,
  clear,
  parseMessage,
  parseBoxData,
  LINETYPE,
  ...
  PLACEMENT,
  addNote,
  setAccTitle: _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.e,
  apply,
  setAccDescription: _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.f,
  getAccDescription: _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.h,
  hasAtLeastOneBox,
...
const bounds = {
  ...
  init: function() {
    ...
    this.verticalPos = 0;
    setConf((0,_mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.d)());
  },
...
function boundMessage(_diagram, msgModel) {
  ...
  const lines = _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.c.splitBreaks(message).length;
  const textDims = _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.u.calculateTextDimensions(message, messageFont(conf));
...
const setConf = function(cnf) {
  (0,_mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.k)(conf, cnf);
  if (cnf.fontFamily) {
...
function adjustLoopHeightForWrap(loopWidths, msg, preMargin, postMargin, addLoopFn) {
  ...
  if (msg.id && msg.message && loopWidths[msg.id]) {
    ...
    msg.message = _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.u.wrapLabel(`[${msg.message}]`, loopWidth - 2 * conf.wrapPadding, textConf);
    msg.width = loopWidth;
    msg.wrap = true;
    const textDims = _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.u.calculateTextDimensions(msg.message, textConf);
    const totalOffset = Math.max(textDims.height, conf.labelBoxHeight);
    heightAdjust = postMargin + totalOffset;
    _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(`${totalOffset} - ${msg.message}`);
  }
  addLoopFn(msg);
  bounds.bumpVerticalPos(heightAdjust);
}
const draw = function(_text, id, _version, diagObj) {
  const { securityLevel, sequence } = (0,_mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.d)();
  conf = sequence;
  diagObj.db.clear();
  ...
  bounds.init();
  _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(diagObj.db);
  const diagram2 = securityLevel === "sandbox" ? root.select(`[id="${id}"]`) : (0,d3__WEBPACK_IMPORTED_MODULE_1__.select)(`[id="${id}"]`);
  const actors2 = diagObj.db.getActors();
  console.info(actors2, "===========");
    ...
    switch (msg.type) {
      ...
      default:
        try {
          ...
          _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.l.error("error while drawing message", e);
        }
    }
    if ([
  ...
  _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("For line height fix Querying: #" + id + " .actor-line");
  const actorLines = (0,d3__WEBPACK_IMPORTED_MODULE_1__.selectAll)("#" + id + " .actor-line");
  ...
  (0,_mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.n)(diagram2, height, width, conf.useMaxWidth);
  const extraVertForTitle = title ? 40 : 0;
  diagram2.attr(
    "viewBox",
    box.startx - conf.diagramMarginX + " -" + (conf.diagramMarginY + extraVertForTitle) + " " + width + " " + (height + extraVertForTitle)
  );
  _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(`models:`, bounds.models);
};
function getMaxMessageWidthPerActor(actors2, messages2, diagObj) {
  ...
  messages2.forEach(function(msg) {
    if (actors2[msg.to] && actors2[msg.from]) {
      ...
      const wrappedMessage = msg.wrap ? _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.u.wrapLabel(msg.message, conf.width - 2 * conf.wrapPadding, textFont) : msg.message;
      const messageDimensions = _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.u.calculateTextDimensions(wrappedMessage, textFont);
  ...
  _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("maxMessageWidthPerActor:", maxMessageWidthPerActor);
...
const getRequiredPopupWidth = function(actor) {
  ...
  for (const key in actor.links) {
    const labelDimensions = _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.u.calculateTextDimensions(key, textFont);
...
function calculateActorMargins(actors2, actorToMessageWidth, boxes2) {
  ...
  Object.keys(actors2).forEach((prop) => {
    ...
    if (actor.wrap) {
      actor.description = _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.u.wrapLabel(
        actor.description,
        conf.width - 2 * conf.wrapPadding,
        actorFont(conf)
      );
    }
    const actDims = _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.u.calculateTextDimensions(actor.description, actorFont(conf));
  ...
  boxes2.forEach((box) => {
    ...
    if (box.wrap) {
      box.name = _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.u.wrapLabel(box.name, totalWidth - 2 * conf.wrapPadding, textFont);
    }
    const boxMsgDimensions = _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.u.calculateTextDimensions(box.name, textFont);
...
const buildNoteModel = function(msg, actors2, diagObj) {
  ...
  let textDimensions = _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.u.calculateTextDimensions(
    shouldWrap ? _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.u.wrapLabel(msg.message, conf.width, noteFont(conf)) : msg.message,
    noteFont(conf)
  );
  const noteModel = {
  ...
  if (msg.placement === diagObj.db.PLACEMENT.RIGHTOF) {
    ...
    textDimensions = _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.u.calculateTextDimensions(
      shouldWrap ? _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.u.wrapLabel(msg.message, Math.max(conf.width, actors2[msg.from].width), noteFont(conf)) : msg.message,
      noteFont(conf)
    );
  ...
  if (shouldWrap) {
    noteModel.message = _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.u.wrapLabel(
      msg.message,
      noteModel.width - 2 * conf.wrapPadding,
      noteFont(conf)
    );
  }
  _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(
...
const buildMessageModel = function(msg, actors2, diagObj) {
  ...
  if (msg.wrap && msg.message) {
    msg.message = _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.u.wrapLabel(
      msg.message,
      Math.max(boundedWidth + 2 * conf.wrapPadding, conf.width),
      messageFont(conf)
    );
  }
  const msgDims = _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.u.calculateTextDimensions(msg.message, messageFont(conf));
  return {
    width: Math.max(
...
const calculateLoopBounds = function(messages2, actors2, _maxWidthPerActor, diagObj) {
  ...
  messages2.forEach(function(msg) {
    msg.id = _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.u.random({ length: 10 });
    switch (msg.type) {
      case diagObj.db.LINETYPE.LOOP_START:
      case diagObj.db.LINETYPE.ALT_START:
      case diagObj.db.LINETYPE.OPT_START:
  ...
  bounds.activations = [];
  _mermaid_cd4fa193_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Loop type widths:", loops);
  return loops;
};
const renderer = {
  bounds,
...
//# sourceMappingURL=sequenceDiagram-817f478e.js.map
